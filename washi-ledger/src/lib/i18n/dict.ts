...
export const dict = {
  zh: {
    ...
    receiptReplace: '重新扫描',
    receiptScanTitle: '确认识别结果',
    receiptCapturedLabel: '拍摄原图',
    receiptRetakeAria: '重新拍摄',
    receiptRecognizingLabel: '识别中…',
    receiptRecognizedLabel: '识别结果',
    receiptRecognizedHint: '如有错误请直接修改',
    receiptPrivacyNote: '※ 拍摄的小票照片本身不会保存，仅识别出的文字内容会生成PDF存档。',
    receiptSaveAsPdf: '存为PDF',
    receiptEmptyError: '没有识别到文字，请重新拍摄或手动跳过',
    receiptFailedError: '识别失败，请重试',
  ...
  ja: {
    ...
    receiptReplace: '撮り直す',
    receiptScanTitle: 'レシートを確認',
    receiptCapturedLabel: '撮影した原本',
    receiptRetakeAria: '撮り直す',
    receiptRecognizingLabel: '認識中…',
    receiptRecognizedLabel: '認識結果',
    receiptRecognizedHint: '間違いがあれば修正してください',
    receiptPrivacyNote: '※ 撮影したレシート画像自体は保存されません。認識されたテキストのみがPDFとして保存されます。',
    receiptSaveAsPdf: 'PDFとして保存',
    receiptEmptyError: 'テキストが認識できませんでした。撮り直すか、スキップしてください',
    receiptFailedError: '認識に失敗しました。もう一度お試しください',
