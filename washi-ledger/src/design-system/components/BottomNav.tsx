...
const items = [
  { to: '/', icon: 'grid_view', labelKey: 'tabDashboard' as const },
  { to: '/history', icon: 'history', labelKey: 'tabHistory' as const },
  { to: '/stats', icon: 'bar_chart', labelKey: 'tabStats' as const },
]
